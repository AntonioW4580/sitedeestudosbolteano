...
// Processar o cadastro da nova matéria
$mensagem = '';
$erro = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($nome)) {
        ...
        $sql_insert = "INSERT INTO questoes (nome, descricao) VALUES (:nome, :descricao)";
...
<head>
    ...
    <title>Criar Nova Matéria - Sistema de Estudos</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <p>Adicione uma nova matéria ao seu sistema de estudos</p>
            </div>
            ...
            <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="nome" name="nome" placeholder="Ex: Física, Português, Matemática..." required>
                </div>
                
                <div class="form-group">
                    <label for="descricao">Descrição (opcional):</label>
                    <textarea id="descricao" name="descricao" placeholder="Breve descrição da matéria..."></textarea>
                </div>
                
                <div style="text-align: center; margin-top: 30px;">
                    <button type="submit" class="btn btn-success">Criar Matéria</button>
