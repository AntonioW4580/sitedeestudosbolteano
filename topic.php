            ...
            <?php else: ?>
                <div class="posts-list">
                    <?php foreach ($subtopics as $subtopic): ?>
                        ...
                        <div class="post-item" style="margin-bottom: 15px; padding-bottom: 15px; border-bottom: 2px solid #eee; position: relative; cursor: pointer; box-shadow: 0px 1px 1px rgba(0,0,0,0.1)" 
